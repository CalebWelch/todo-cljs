...
if((i < len)){
var k = (ks[i]);
var G__9628 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__9629 = (i + (1));
m = G__9628;
i = G__9629;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9508 = c;
var G__9508__$1 = (((G__9508 == null))?null:G__9508.prototype);
if((G__9508__$1 == null)){
return null;
} else {
return G__9508__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9514 = c;
...
var G__9532 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__9532) : reagent.impl.component.as_element.call(null,G__9532));
};
...
var G__9533 = c;
var G__9533__$1 = (((G__9533 == null))?null:G__9533.constructor);
if((G__9533__$1 == null)){
return null;
} else {
return G__9533__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__9543 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9544 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9544);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9543);
}});
...
var c = this;
var G__9563_9739 = goog.object.get(c,"cljsRatom");
if((G__9563_9739 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9563_9739);
}
...
var renders_9746 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9747 = cljs.core.first(cljs.core.vals(renders_9746));
...
if((cljs.core.count(renders_9746) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9746))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9747)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9747], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9590 = o;
goog.object.set(G__9590,cljs.core.name(k),v);
