...
var G__9749 = o;
goog.object.set(G__9749,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__9949__i < G__9949__a.length) {G__9949__a[G__9949__i] = arguments[G__9949__i + 0]; ++G__9949__i;}
  args = new cljs.core.IndexedSeq(G__9949__a,0,null);
} 
...
var G__9756 = o;
goog.object.set(G__9756,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__9764 = props;
var G__9764__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9764,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9764);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9764__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__9764__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9770 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9770,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9770;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__9775){
var map__9777 = p__9775;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9777__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__9792_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__9792_SHARP_);
}));
} else {
return null;
}
...
var vec__9812 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9812,(2),null);
...
var key_10029 = temp__5739__auto___10026;
...
var temp__5739__auto___10056 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___10056 == null)){
} else {
var key_10060 = temp__5739__auto___10056;
(jsprops.key = key_10060);
}
...
var G__9836 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__9836) : reagent.impl.template.as_element.call(null,G__9836));
} else {
var temp__5739__auto___10074 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___10074 == null)){
} else {
var key_10075 = temp__5739__auto___10074;
...
var G__9848 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__9848)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__9848)){
return x;
} else {
...
var len__4789__auto___10080 = arguments.length;
var i__4790__auto___10081 = (0);
while(true){
if((i__4790__auto___10081 < len__4789__auto___10080)){
args__4795__auto__.push((arguments[i__4790__auto___10081]));

var G__10083 = (i__4790__auto___10081 + (1));
i__4790__auto___10081 = G__10083;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9850){
var G__9851 = cljs.core.first(seq9850);
var seq9850__$1 = cljs.core.next(seq9850);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9851,seq9850__$1);
}));
...
break;
default:
var G__10097 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10097;
continue;
...
var ctx = ({});
var vec__9917 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9917,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9917,(1),null);
...
var G__9927 = (cljs.core.count(argv) - first_child);
switch (G__9927) {
case (0):
