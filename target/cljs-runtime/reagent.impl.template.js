...
var G__42444 = o;
goog.object.set(G__42444,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__42464 = o;
goog.object.set(G__42464,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__42556.cljs$lang$applyTo = (function (arglist__42560){
var args = cljs.core.seq(arglist__42560);
...
var G__42496 = props;
var G__42496__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42496,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__42496);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42496__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__42496__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__42506 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42506,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__42506;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__42511){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42512__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__42515_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__42515_SHARP_);
}));
} else {
return null;
}
...
var vec__42528 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42528,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42528,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42528,(2),null);
...
var temp__5739__auto___42572 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___42572 == null)){
} else {
var key_42577 = temp__5739__auto___42572;
(jsprops.key = key_42577);
}
...
var temp__5739__auto___42586 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___42586 == null)){
} else {
var key_42591 = temp__5739__auto___42586;
...
var G__42539 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
...
var temp__5739__auto___42597 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___42597 == null)){
} else {
var key_42598 = temp__5739__auto___42597;
...
var G__42541 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__42541)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__42541)){
return x;
} else {
...
var len__4789__auto___42604 = arguments.length;
var i__4790__auto___42605 = (0);
while(true){
if((i__4790__auto___42605 < len__4789__auto___42604)){
args__4795__auto__.push((arguments[i__4790__auto___42605]));

var G__42607 = (i__4790__auto___42605 + (1));
i__4790__auto___42605 = G__42607;
continue;
} else {
}
break;
...
break;
default:
var G__42614 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__42614;
continue;
...
var ctx = ({});
var vec__42549 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42549,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42549,(1),null);
...
var G__42552 = (cljs.core.count(argv) - first_child);
switch (G__42552) {
case (0):
